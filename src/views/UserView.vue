...
const profile = reactive({ nickname: "管理员", email: "admin@example.com", userPic: "" });
function save() {
  dialog.value = false;
}
</script>
<template>
  <section class="page-panel glass">
    ...
    <el-descriptions :column="1" border
      ...
      ></el-descriptions
    ><el-dialog v-model="dialog" title="编辑个人资料" width="460px"
      ><el-form label-width="70px"
        ...
        ><el-form-item label="头像地址"
          ><el-input
            ...
            placeholder="可接入 /upload 接口" /></el-form-item></el-form
      ><template #footer
